...
public class ServicioTienda {
	...
	public void crearTienda() {
		...
		Tienda store1 = new Tienda(1, "carrera 30 con calle 15", "Stephany");
		Tienda store2 = new Tienda(2, "carrera 10 con calle 10", "Lola");

		listStores.add(store1);
	...
	public Producto buscarProducto() {
		...
		System.out.print("Ingresa el nombre del producto que busca: ");
	...
	public void modificarTienda() {
		if (tiendaSeleccionada != null) {
			...
			case 1:
				leer.nextLine();
				System.out.print("Ingresa la nueva dirreccion: ");
				tiendaSeleccionada.setDireccion(leer.nextLine());
				break;
			case 2:
				leer.nextLine();
				System.out.print("Ingresa el nombre del representante: ");
